# 🤖 AI PRD Generator — Product Requirements Document Builder
...
**Input:** Product name, problem statement, target users, features, KPIs
...
1. Standardising PRD structure across teams
2. Reducing first-draft time from 2 hours to 2 minutes
3. Ensuring all critical PM artefacts are covered every time
4. Making AI practical for everyday product management work
...
### Option C — Enable AI Generation
The app works with template outputs by default. To enable Claude AI:
1. Get an API key from [console.anthropic.com](https://console.anthropic.com)
2. Open `index.html` and locate the fetch call
3. Add your API key to the Authorization header
4. Regenerate PRDs with full AI power

---

## 📋 PRD Templates Included
...
## 📊 Product Management Concepts Used
